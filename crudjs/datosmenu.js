...
var manejadordatosmenu;

$(document).ready(function(){
	manejadordatosmenu =$("#manejadordatosmenu").DataTable({
		"ajax" : "../../Controlador/s_Menu/c_MenuGet.php",
		"order" : [],
		"oLanguage": {
	...
	$("#adddatosModalBtn").on('click',function(){
		...
		$("#createmenuform").unbind('submit').bind('submit', function() {
