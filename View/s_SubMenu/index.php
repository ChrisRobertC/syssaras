      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
           ...
           <div class="col-md-12 col-lg-12 col-xs-12 col-md-12">
            <center><h1 class="page-heading">Sub Menu <small></small></h1></center>
            ...
            <table class="table" id="manejadordatossubmenu">
   ...
   <div class="modal fade" id="adddatos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="../../Controlador/s_SubMenu/c_SubMenuCreate.php" method="POST" id="createsubmenuform">
          <div class="modal-body">
           ...
           <div class="form-group">
             ...
             <div class="col-sm-10">
               <select name="ddlmenu" id="ddlmenu" class="form-control">
...
<!--Elimnar modal-->
<div class="modal" tabindex="-1" role="dialog" id="eliminarsubmenuModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<!--EDITAR-->
<div class="modal" tabindex="-1" role="dialog" id="editarsubmenuModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form class="form-horizontal" action="../../Controlador/s_SubMenu/c_SubMenuUpdate.php" method="POST" id="updatesubmenuform">
        <div class="modal-body">
         <div class="editar_messages"></div>
          <div class="form-group">
             <label class="col-sm-2 control-label">Menu Padre</label>
             <div class="col-sm-10">
               <select name="ddlemenu" id="ddlemenu" class="form-control">
                 <option value="">Seleccione</option>
                 <?php 
                    require_once('../../config/Conexion/conexion.php');
                    require_once('../../Modelo/s_Menu/ms_Menu.php');
 ...
 <div class="modal-footer editsubmenuModalid">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
...
<script type="text/javascript" src="../../crudjs/datossubmenu.js"></script>
